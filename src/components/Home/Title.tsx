...
const Title = () => {
  return <div className="snap-start relative justify-center items-center flex w-screen h-screen">
    <div className=' animate-titleMove'>
      ...
      <div className='flex mt-[2rem] gap-[2rem]'>
        <img src={title1} className='origin-bottom opacity-0 animate-title1In h-[10vh]'  />
        <img src={title2} className='origin-bottom opacity-0 animate-title2In h-[10vh]'  />
      </div>
    </div>
    <img src={imageA}  className='w-[25vw] opacity-0 animate-imageIn absolute left-[35%] bottom-[5%] z-[10]' />
    <img src={imageB} className='absolute animate-imageIn opacity-0 w-[45vw] right-[7%] bottom-[15%] z-[9]' alt="" />
    <div className='absolute animate-buttonIn opacity-0 flex cursor-pointer justify-center group items-center left-[3rem] bottom-[10rem] bg-black rounded-full w-[20rem] h-[6rem]'>
      <div className='h-[3rem] overflow-hidden hover:text-black relative w-[12rem] rounded-full border-white border-[1px] text-center text-white text-[24px] leading-[3rem] font-light before:w-[0] before:transition-all before:bg-white before:absolute before:top-0 before:left-0 before:hover:w-full before:h-full'>
        <p className='absolute z-[999] top-[0] left-[1rem] w-[10rem] h-[3rem] transition-all tracking-tight font-mono'>get start</p>
      </div>
