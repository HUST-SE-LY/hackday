...
const Operator = observer(() => {
  ...
  const [currentOperatorMode, setCurrentOperatorMde] = useState('history');
  const getOperatorComponent = () => {
    if (currentOperatorMode === 'history') {return <History></History>}
    else if (currentOperatorMode === 'search') {return <Search></Search>}
        ...
        <div className="ml-[1.5rem] basis-[16.5rem] flex flex-col">
            ...
            <div className="mt-[4rem] mb-[1rem]">
                <div className="flex items-center gap-[1rem]">
                    ...
                    onClick={() => {setCurrentOperatorMde('history')}}
                    >
                    ...
                    <div 
                    className="group hover:bg-indigo-600 w-[2.5rem] h-[2.5rem] rounded-full"
                    onClick={() => {setCurrentOperatorMde('search')}}
                    >
                    ...
                    <div 
                    className="group hover:bg-indigo-600 w-[2.5rem] h-[2.5rem] rounded-full"
                    onClick={() => {setCurrentOperatorMde('folder')}}
                    >
